...
set(CMAKE_C_FLAGS "${MPI} -g -unroll-aggressive -finline-functions ${CMAKE_C_FLAGS}")
set(CMAKE_CXX_FLAGS "${MPI} -g -unroll-aggressive -finline-functions ${CMAKE_CXX_FLAGS}")

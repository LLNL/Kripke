...
void Kernel_3d_DZG::sweep(Subdomain *sdom) {
  ...
  View3d<double, PERM_IKJ> const rhs(sdom->rhs->ptr(), num_directions, num_groups, num_zones);
  View3d<double, PERM_IKJ> psi(sdom->psi->ptr(), num_directions, num_groups, num_zones);
  ...
  View3d<double, PERM_IKJ> psi_lf(sdom->plane_data[0]->ptr(), num_directions, num_groups, num_z_i);
  View3d<double, PERM_IKJ> psi_fr(sdom->plane_data[1]->ptr(), num_directions, num_groups, num_z_j);
  View3d<double, PERM_IKJ> psi_bo(sdom->plane_data[2]->ptr(), num_directions, num_groups, num_z_k);

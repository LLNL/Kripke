...
void Kernel_3d_ZDG::sweep(Subdomain *sdom) {
  ...
  View3d<double, PERM_KIJ> const rhs(sdom->rhs->ptr(), num_directions, num_groups, num_zones);
  View3d<double, PERM_KIJ> psi(sdom->psi->ptr(), num_directions, num_groups, num_zones);
  ...
  View3d<double, PERM_KIJ> psi_lf(sdom->plane_data[0]->ptr(), num_directions, num_groups, num_z_i);
  View3d<double, PERM_KIJ> psi_fr(sdom->plane_data[1]->ptr(), num_directions, num_groups, num_z_j);
  View3d<double, PERM_KIJ> psi_bo(sdom->plane_data[2]->ptr(), num_directions, num_groups, num_z_k);

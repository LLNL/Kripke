...
#define __DOMAIN_LAYOUT_H__
    ...
    struct LAYOUT_IJKL_t {};
    struct LAYOUT_IJLK_t {};
    struct LAYOUT_IKJL_t {};
    struct LAYOUT_IKLJ_t {};
    struct LAYOUT_ILJK_t {};
    struct LAYOUT_ILKJ_t {};
    struct LAYOUT_JIKL_t {};
    struct LAYOUT_JILK_t {};
    struct LAYOUT_JKIL_t {};
    struct LAYOUT_JKLI_t {};
    struct LAYOUT_JLIK_t {};
    struct LAYOUT_JLKI_t {};
    struct LAYOUT_KIJL_t {};
    struct LAYOUT_KILJ_t {};
    struct LAYOUT_KJIL_t {};
    struct LAYOUT_KJLI_t {};
    struct LAYOUT_KLIJ_t {};
    struct LAYOUT_KLJI_t {};
    struct LAYOUT_LIJK_t {};
    struct LAYOUT_LIKJ_t {};
    struct LAYOUT_LJIK_t {};
    struct LAYOUT_LJKI_t {};
    struct LAYOUT_LKIJ_t {};
    struct LAYOUT_LKJI_t {};
    enum LAYOUT4D {
      LAYOUT_IJKL,
      LAYOUT_IJLK,
      LAYOUT_IKJL,
